...
<div class="container">
  <div class="row justify-content-between align-items-center">
    ...
    <div class="col-lg-5 col-md-5 mb-4 order-lg-2 order-md-2 order-1">
      <img src="https://th.bing.com/th/id/OIP.UMwlUoXJ0HhSGsfUF_BOzgHaE7?rs=1&pid=ImgDetMain" class="w-100">
    </div>
  </div>
</div>
...
<div class="container px-4">
  <div class="swiper mySwiper">
    <div class="swiper-wrapper mb-5 ms-5">
      <div class="swiper-slide bg-white text-center overflow-hidden rounded">
        <img src="https://th.bing.com/th/id/OIP.YHCtUpoNz1wqYbf0d9tIUQHaLO?rs=1&pid=ImgDetMain" class="w-100">
        <h5 class="mt-5">Random Name</h5>
      </div>
      <div class="swiper-slide bg-white text-center overflow-hidden rounded">
        <img src="https://th.bing.com/th/id/OIP.GFDMh97XTxatu-zm1oFfyAHaJP?rs=1&pid=ImgDetMain" height="520" class="w-100">
        <h5 class="mt-2">Random Name</h5>
      </div>
      <div class="swiper-slide bg-white text-center overflow-hidden rounded">
        <img src="https://img.freepik.com/premium-photo/smart-businesswoman-is-sitting-chair-doing-retouching-work-office_567313-10909.jpg" height="510" class="w-100">
        <h5 class="mt-2">Random Name</h5>
      </div>
      <div class="swiper-slide bg-white text-center overflow-hidden rounded">
        <img src="https://learncodingusa.com/wp-content/uploads/2023/10/Front-End-vs-Back-End-Whats-the-Difference-.jpeg" height="500"  class="w-100">
        <h5 class="mt-2">Random Name</h5>
      </div>
      <div class="swiper-slide bg-white text-center overflow-hidden rounded">
        <img src="https://anindigoday.com/wp-content/uploads/2017/10/fall-office-outfit-ideas-styling-a-plaid-oversized-blazer-My-Style-Vita-@mystylevita-16.jpg" height="500" class="w-100">
        <h5 class="mt-2">Random Name</h5>
      </div>
      <div class="swiper-slide bg-white text-center overflow-hidden rounded">
        <img src="https://th.bing.com/th/id/OIP.rBvOWCLz9H9jdD3bHrXRJgHaLH?w=1080&h=1620&rs=1&pid=ImgDetMain" height="500" class="w-100">
        <h5 class="mt-2">Random Name</h5>
      </div>
      <div class="swiper-slide bg-white text-center overflow-hidden rounded">
        <img src="https://th.bing.com/th/id/OIP.HJjTuiZEp7EFoQe6PPT0QwHaL4?w=866&h=1390&rs=1&pid=ImgDetMain" height="500" class="w-100">
        <h5 class="mt-2">Random Name</h5>
      </div>
      <div class="swiper-slide bg-white text-center overflow-hidden rounded">
        <img src="https://th.bing.com/th/id/OIP.Lk6OPNfxeoO6hmmuvmx5LgHaHe?w=1600&h=1614&rs=1&pid=ImgDetMain" height="500" class="w-100">
        <h5 class="mt-2">Random Name</h5>
      </div>
    </div>
